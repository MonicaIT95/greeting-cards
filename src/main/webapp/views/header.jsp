...
<title>online Greeting Cards store</title>
</head>
<body>
<center><h1>Greeting Cards</h1>
<p>The site you can get your favourite Cards.</p></center>
<nav class="navbar navbar-inverse ">
  <div class="container-fluid">
    <div class="navbar-header">
    <a href="index" class="pull-left"><img src="http://www.wordmstemplates.com/wp-content/uploads/2015/09/Greeting-Card-template-6698.jpg" width="70" height="50"></a>
     <div class="navbar-brand">Greeting Cards</div>
    </div>
    ...
    <ul class="nav navbar-nav">
      ...
      <li class="dropdown">
		...
		<li><a href="categoryDropdown/${category.id}">${category.name}</a></li>
          ...
          <!-- <li><a href="kids book"> Valentines;</a></li>
